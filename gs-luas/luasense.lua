    ...
    menu = {
        ...
        ["visuals & misc"] = {
            ...
            ["visuals"] = {
                ...
                wtext = ui.new_combobox("aa", "anti-aimbot angles", prefix("wutermark"), {" luasense ", "luasense beta", "luasync.max2", "luasync.max", " luasense", "luasense ", "luasense", "w3LLy$eN$E", "custom"}),
